...
```text
test_total_agent_next_closure_constants_are_registered_and_unique
test_total_agent_answer_learning_question_uses_mock_evidence_without_mutating_plan
test_total_agent_answer_learning_question_no_evidence_returns_warning
test_total_agent_agent_final_result_uses_answer_state_fallback
