...
# Message sources
BUDDY_MESSAGE_SOURCE_CHAT = "chat"
BUDDY_MESSAGE_SOURCE_PROACTIVE = "proactive"
BUDDY_MESSAGE_SOURCE_EVENT = "event"
BUDDY_MESSAGE_SOURCE_SYNTHESIS = "synthesis"

# Synthesis cache (seconds)
BUDDY_SYNTHESIS_CACHE_SECONDS = 300  # 5 minutes
