...
def _build_profile_input_records(level: str, now_ts: int) -> dict:
    ...
    if level == LEVEL_LOW:
        ...
        return {
            ...
            "learning_goal": "系统掌握HBase分布式数据库基础知识",
            "learning_records": [
                {"event_type": "study_session", "topic": "大数据基础", "duration_minutes": 40, "status": "completed", "score": 0.88, "started_at": now_ts - 3628800, "meta": {"knowledge_points": ["大数据基础"]}},
                {"event_type": "study_session", "topic": "数据感知与获取", "duration_minutes": 35, "status": "completed", "score": 0.85, "started_at": now_ts - 3024000, "meta": {"knowledge_points": ["数据感知"]}},
                {"event_type": "study_session", "topic": "ETL过程", "duration_minutes": 35, "status": "completed", "score": 0.82, "started_at": now_ts - 2419200, "meta": {"knowledge_points": ["ETL"]}},
                {"event_type": "study_session", "topic": "HDFS 基础", "duration_minutes": 45, "status": "completed", "score": 0.86, "started_at": now_ts - 1814400, "meta": {"knowledge_points": ["HDFS 基础"]}},
                {"event_type": "practice", "topic": "HDFS读写流程", "duration_minutes": 25, "status": "completed", "score": 0.80, "started_at": now_ts - 1728000, "meta": {"knowledge_points": ["HDFS读写流程"]}},
                {"event_type": "study_session", "topic": "HBase 基础", "duration_minutes": 30, "status": "partial", "score": 0.48, "started_at": now_ts - 345600, "meta": {"knowledge_points": ["HBase 基础"]}},
            ],
            "answer_records": [
                {"question": "HDFS的NameNode负责什么？", "correct": True, "time_spent_seconds": 75, "answered_at": now_ts - 1728000, "meta": {"knowledge_points": ["HDFS 基础"]}},
                {"question": "ETL中数据转换的常见挑战？", "correct": True, "time_spent_seconds": 90, "answered_at": now_ts - 2246400, "meta": {"knowledge_points": ["ETL"]}},
                {"question": "HBase和HDFS的关系是什么？", "correct": False, "time_spent_seconds": 120, "answered_at": now_ts - 259200, "meta": {"knowledge_points": ["HBase 基础", "HDFS 基础"]}},
                {"question": "HBase数据模型包含哪些核心概念？", "correct": False, "time_spent_seconds": 110, "answered_at": now_ts - 172800, "meta": {"knowledge_points": ["HBase 数据模型"]}},
            ],
            "resource_usage": [
                {"resource_id": "doc-bigdata-intro", "resource_type": "documents", "action": "complete", "duration_seconds": 800, "timestamp": now_ts - 3456000, "meta": {"knowledge_points": ["大数据基础"]}},
                {"resource_id": "doc-hdfs-001", "resource_type": "documents", "action": "complete", "duration_seconds": 700, "timestamp": now_ts - 1728000, "meta": {"knowledge_points": ["HDFS 基础"]}},
                {"resource_id": "quiz-hdfs-001", "resource_type": "quiz", "action": "submit", "score": 0.82, "duration_seconds": 300, "timestamp": now_ts - 1641600, "meta": {"knowledge_points": ["HDFS 基础"]}},
            ],
        }
    else:  # HIGH
        return {
            "dialogue_text": [
                ...
                "对RowKey热点和预分区策略还有疑惑，需要加强复习。",
                "希望针对弱项进行有重点的巩固练习。",
            ],
            "learning_goal": "巩固大数据核心技术，强化RowKey热点与预分区知识",
            "learning_records": [
                {"event_type": "study_session", "topic": "大数据基础", "duration_minutes": 40, "status": "completed", "score": 0.91, "started_at": now_ts - 7257600, "meta": {"knowledge_points": ["大数据基础"]}},
                {"event_type": "study_session", "topic": "数据感知与获取", "duration_minutes": 35, "status": "completed", "score": 0.87, "started_at": now_ts - 6652800, "meta": {"knowledge_points": ["数据感知"]}},
                {"event_type": "study_session", "topic": "ETL过程", "duration_minutes": 35, "status": "completed", "score": 0.84, "started_at": now_ts - 6048000, "meta": {"knowledge_points": ["ETL"]}},
                {"event_type": "study_session", "topic": "HDFS 基础", "duration_minutes": 45, "status": "completed", "score": 0.89, "started_at": now_ts - 5443200, "meta": {"knowledge_points": ["HDFS 基础"]}},
                {"event_type": "practice", "topic": "HDFS读写流程", "duration_minutes": 30, "status": "completed", "score": 0.83, "started_at": now_ts - 4838400, "meta": {"knowledge_points": ["HDFS读写流程"]}},
                {"event_type": "study_session", "topic": "HBase 基础", "duration_minutes": 45, "status": "completed", "score": 0.82, "started_at": now_ts - 4233600, "meta": {"knowledge_points": ["HBase 基础"]}},
                {"event_type": "study_session", "topic": "MapReduce 基础", "duration_minutes": 40, "status": "completed", "score": 0.76, "started_at": now_ts - 3628800, "meta": {"knowledge_points": ["MapReduce 基础"]}},
                {"event_type": "study_session", "topic": "HBase RowKey 设计", "duration_minutes": 35, "status": "partial", "score": 0.48, "started_at": now_ts - 1209600, "meta": {"knowledge_points": ["HBase RowKey 设计"]}},
                {"event_type": "study_session", "topic": "RowKey 热点规避", "duration_minutes": 30, "status": "partial", "score": 0.42, "started_at": now_ts - 864000, "meta": {"knowledge_points": ["RowKey 热点"]}},
            ...
            "answer_records": [
                {"question": "HDFS的NameNode和DataNode各自负责什么？", "correct": True, "time_spent_seconds": 70, "answered_at": now_ts - 4838400, "meta": {"knowledge_points": ["HDFS 基础"]}},
                {"question": "ETL过程中数据转换的常见挑战？", "correct": True, "time_spent_seconds": 85, "answered_at": now_ts - 5443200, "meta": {"knowledge_points": ["ETL"]}},
                {"question": "HBase的RowKey设计原则有哪些？", "correct": False, "time_spent_seconds": 130, "answered_at": now_ts - 864000, "meta": {"knowledge_points": ["HBase RowKey 设计"]}},
                {"question": "什么是预分区？为什么需要预分区？", "correct": False, "time_spent_seconds": 140, "answered_at": now_ts - 604800, "meta": {"knowledge_points": ["预分区"]}},
                {"question": "MapReduce的执行流程是什么？", "correct": True, "time_spent_seconds": 90, "answered_at": now_ts - 3024000, "meta": {"knowledge_points": ["MapReduce 基础"]}},
                {"question": "RowKey热点是怎么产生的？", "correct": False, "time_spent_seconds": 120, "answered_at": now_ts - 518400, "meta": {"knowledge_points": ["RowKey 热点"]}},
            ],
            "resource_usage": [
                {"resource_id": "doc-intro-001", "resource_type": "documents", "action": "complete", "duration_seconds": 800, "timestamp": now_ts - 6900000, "meta": {"knowledge_points": ["大数据基础"]}},
                {"resource_id": "doc-hdfs-001", "resource_type": "documents", "action": "complete", "duration_seconds": 700, "timestamp": now_ts - 5100000, "meta": {"knowledge_points": ["HDFS 基础"]}},
                {"resource_id": "quiz-hdfs-001", "resource_type": "quiz", "action": "submit", "score": 0.82, "duration_seconds": 300, "timestamp": now_ts - 5000000, "meta": {"knowledge_points": ["HDFS 基础"]}},
                {"resource_id": "doc-hbase-001", "resource_type": "documents", "action": "complete", "duration_seconds": 750, "timestamp": now_ts - 4000000, "meta": {"knowledge_points": ["HBase 基础"]}},
                {"resource_id": "mindmap-hbase-001", "resource_type": "mindmap", "action": "complete", "duration_seconds": 400, "timestamp": now_ts - 3900000, "meta": {"knowledge_points": ["HBase 基础"]}},
            ],
        }
